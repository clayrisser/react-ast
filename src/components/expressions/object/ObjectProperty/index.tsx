/**
 * File: /src/components/expressions/object/ObjectProperty/index.tsx
 * Project: react-ast
...
const ObjectProperty = forwardRef<BaseElement, ObjectPropertyProps>(
  (props: ObjectPropertyProps, forwardedRef: Ref<BaseElement>) => {
